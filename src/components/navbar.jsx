...
const navbar = () => {
  ...
  return (
    <div className="bg-nav dark:bg-neutral-700">
      <div className="flex justify-between items-center w-[92%] mx-auto">
        <div className="">
          <img className="md:w-16 w-12 p-1 my-1.5" src={logo} alt="" />
        </div>
        <div className={`${isMenuOpen ? "top-[8%] bg-white dark:bg-neutral-700" : "top-[-100%]"} md:static absolute md:min-h-fit min-h-[50vh] left-0 md:w-auto w-full flex items-center px-5 duration-150`}>
          <div className="flex md:flex-row flex-col md:items-center md:gap-[5vw] gap-8 text-lg font-medium md:ml-0 ml-4">
            <Link>
              <p className="hover:text-gray-500 text-black dark:text-gray-100">Home</p>
            </Link>
            <Link>
              <p className="hover:text-gray-500 text-[#9C33C1]">Blog</p>
            </Link>
            <Link>
              <p className="hover:text-gray-500 text-black dark:text-gray-100">Drugs</p>
            </Link>
            <Link>
              <p className="hover:text-gray-500 text-black dark:text-gray-100">Clinic</p>
            </Link>
            <Link>
              <p className="hover:text-gray-500 text-black dark:text-gray-100">Midwife</p>
            </Link>
            <Link>
              <p className="hover:text-gray-500 text-black dark:text-gray-100">Analysis</p>
            </Link>
          </div>
        </div>
