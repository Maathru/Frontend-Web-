...
const LocationAddPopup = () => {
  return (
    <Popup
      trigger={
        <div className="flex col-start-2 col-span-2 w-full justify-center items-center bg-gray-300 w-96 px-5 py-2 h-full rounded-sm hover:bg-gray-400">
      ...
      <div className="rounded-md bg-white dark:bg-dark-popup w-[1000px] h-[600px]">
        ...
        <div className="flex w-full px-5">
          ...
          <div className="w-4/12">
            ...
            />
            <Typography>
              For the midwife home visits, she will arrive at the above location
              marked by the pin. Please relocate the pin if it's at the
              incorrect location
            </Typography>
          </div>
        </div>
